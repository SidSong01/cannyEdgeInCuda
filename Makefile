...
cannyEdgeDetc.o: cannyEdgeDetc.cu
	$(EXEC) $(NVCC) $(INCLUDES) $(ALL_CCFLAGS) $(GENCODE_FLAGS) -o $@ -c $< -ljpeg

cannyEdgeDetc: cannyEdgeDetc.o
...
clean:
	rm -f cannyEdgeDetc cannyEdgeDetc.o
	rm -rf ../../bin/$(TARGET_ARCH)/$(TARGET_OS)/$(BUILD_TYPE)/cannyEdgeDetc
